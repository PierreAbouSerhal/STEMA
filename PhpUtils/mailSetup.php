...
require_once($_SERVER["DOCUMENT_ROOT"]."/STEMA/PhpUtils/PhpMailer/src/Exception.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/STEMA/PhpUtils/PhpMailer/src/PHPMailer.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/STEMA/PhpUtils/PhpMailer/src/SMTP.php");
